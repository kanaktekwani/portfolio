        ...
        <div className="what-box-in">
          ...
          >
            ...
            <div className="what-content-in">
              ...
              <h4>Distributed services and reliable APIs</h4>
              <p>
                I design and build distributed backend systems, cloud
                infrastructure, and AI-enabled applications using modern DevOps
          ...
          >
            ...
            <div className="what-content-in">
              ...
              <h4>Infrastructure, DevOps, and AI workflows</h4>
              <p>
                I work across AWS, containers, CI/CD, and infrastructure as code
                to make systems easier to deploy, operate, monitor, and improve.
              </p>
              <h5>Skillset & tools</h5>
              <div className="what-content-flex">
